...
<body>
    ...
    <h3>Aqui editaremos el Editorial del libro</h3>

    
    <!-- Tenemos que poner la ruta que va llamar, en este caso la route update pero mandandole el id de lo que vamos a editar -->
    <!-- laravel no me deja poner put de manera directa en los formularios, para ello lo llamamos manualmente -->
    <form action="{{route('editorials.update', $editorial->id)}}" method="post">
        ...
        <input type="text" name="country" value="{{$editorial->country}}">
